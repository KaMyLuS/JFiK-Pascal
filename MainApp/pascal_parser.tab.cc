...
#line 436 "pascal_parser.tab.cc"
  ...
  /* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
     STATE-NUM.  */
  const signed char Pascal_Parser::yypact_ninf_ = -1;
  const signed char
  ...
  const signed char Pascal_Parser::yytable_ninf_ = -1;
  const unsigned char
  ...
  "RPAREN", "NOT_P", "AND_P", "OR_P", "WRONG", "$accept", "program", YY_NULL
  };
  ...
  const int Pascal_Parser::yylast_ = 1;
  const int Pascal_Parser::yynnts_ = 2;
  const int Pascal_Parser::yyempty_ = -2;
  const int Pascal_Parser::yyfinal_ = 3;
...
/* Line 1141 of lalr1.cc  */
#line 862 "pascal_parser.tab.cc"
/* Line 1142 of lalr1.cc  */
#line 102 "pascal_parser.yy"
